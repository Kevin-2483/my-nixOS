{ lib, ... }:
{
  system.defaults = {
    finder = {
      ...
      FXPreferredViewStyle = "Nlsv"; #Finder 的首選視圖樣式。 “icnv”= 圖示視圖、“Nlsv”= 清單視圖、“clmv”= 列視圖、“Flwv”= 圖庫視圖 預設為 icnv。
    ...
    SoftwareUpdate.AutomaticallyInstallMacOSUpdates = false; #是否自動安裝 macOS 更新。預設為 false。
    dock = {
